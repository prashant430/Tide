---
layout: blog
permalink: /articles/expanding-horizons
...
video_path: ''
short-description: >-
  Marco Bonelli and Marijana Radovic, the duo behind Milan-based studio
...
images:
  - image: >-
    ...
    credit:
  - image: >-
      /uploads/issue-11/tide-magazine-sailing-lifestyle-travel-issue11-design-2.jpg
    caption: false
    credit:
  - image: >-
      /uploads/issue-11/tide-magazine-sailing-lifestyle-travel-issue11-design-3.jpg
    caption: false
    credit:
  - image: >-
      /uploads/issue-11/tide-magazine-sailing-lifestyle-travel-issue11-design-4.jpg
    caption: false
    credit:
---
When you spend time examining the landscape of yacht design, you start to observe that designers in the genre tend to fall into two distinct categories. On the one hand you have specialists who have always focused exclusively on spaces that sail, while others have come over from residential projects or commercial fields and grown to include yachts in their portfolios. Milan-based architects m<sup>2</sup>atelier, jointly helmed by designers Marco Bonelli and Marijana Radovic, fall into the latter camp.

Combining Bonelli’s high-end residential and retail architectural skills with Radovic’s previous experience in boatcraft, m<sup>2</sup>atelier operates as a multidisciplinary studio, exploring homes, stores, hotels, restaurants and product design, yet with a distinct affinity with yachting and high-end projects. Such versatility enables m<sup>2</sup>atelier to incorporate unique elements of yacht design into its residential work, and vice versa. Over the past 20 years, the studio has established lasting partnerships with prestigious brands and renowned shipyards, delivering an impressive range of motor and sailing yachts from 30 metres to 90 metres, both completed and in progress.
...
With a belief that design has the power to inspire, uplift and foster a deeper connection between people and their surroundings, m<sup>2</sup>atelier’s creative approach could not be more appropriate for yacht design. “Indoor-outdoor living is a concept that is very important in our designs and something that we translate into all our projects, be it for residential properties or yacht interiors,” explains Bonelli. “We often emphasise a connection to nature, creating fluid transitions between the inside and outside. This is something that comes naturally in yacht design as the interaction between the guests and the sea is enhanced through clean layouts, opening the space to the exterior where possible.”

And the studio’s commitment to sustainability is integrated throughout every aspect of its design process. “Prioritising eco-conscious materials is central to our work. True luxury doesn’t need to compromise environmental responsibility,” says Radovic. “We all have a role, and we have to take small steps that will bring us to a better future and make the next generation proud.”

[*m2atelier.com*](https://www.m2atelier.com/){: target="_blank" rel="noopener"}